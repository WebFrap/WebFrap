...
/*@var $backpath BdlProfileBackpath */
$idPrefix = 'profile-backpath-create';
...
<form 
  id="<?php echo $formId ?>"
  action="ajax.php?c=Daidalos.BdlNode_ProfileBackpath.insert&amp;key=<?php echo $VAR->key ?>&amp;bdl_file=<?php echo $VAR->bdlFile ?>"
  method="post"
></form>
