...
$areas = $profile->getAreaPermissions();
...
<div
  ...
  <div class="wgt-space" >
    ...
    <ul id="wgt-list-<?php echo $idPrefix ?>-permission" class="wcm wcm_ui_tree bw7" >
    <?php $idx = 0; foreach( $areas as $area ){ ?>
      <li id="wgt-node-<?php echo $idPrefix ?>-permission-<?php echo $idx; ?>" >
        <span><?php echo $area->getName( true ); ?></span>
        <div class="right" style="width:90px;" >
          <button 
            class="wgt-button wgtac_add_permission_base_ref"
            wgt_key="<?php echo $area->getName(); ?>" 
            wgt_path="<?php echo $idx; ?>" ><?php echo $iconAdd; ?></button><button 
