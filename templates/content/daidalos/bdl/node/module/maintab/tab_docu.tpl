   ...
   >
    ...
    <div
      ...
      <div id="wgt-tab-<?php echo $idPrefix ?>_docu-body" class="wgt_tab_body" >
        ...
        <div
          id="wgt-tab-<?php echo $idPrefix ?>-docu-<?php echo $lang ?>"
          title="<?php echo $lang ?>"
          wgt_icon="xsmall/flags/<?php echo $lang ?>.png"
          class="wgt_tab wgt-tab-<?php echo $idPrefix ?>_docu">

          <fieldset
            id="wgt-fieldset-<?php echo $idPrefix ?>-docu-<?php echo $lang ?>"
      ...
      <var id="wgt-tab-<?php echo $idPrefix ?>_docu-cfg-i18n-input-tab" >
      {
        ...
        "inp_prefix":"<?php echo $nodeKey ?>[docu]",
