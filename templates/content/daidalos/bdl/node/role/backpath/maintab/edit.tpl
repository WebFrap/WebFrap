...
<form
  id="<?php echo $formId ?>"
  action="ajax.php?c=Daidalos.BdlNode_<?php echo $domainClass ?>Backpath.update&amp;key=<?php echo $VAR->key ?>&amp;bdl_file=<?php echo $VAR->bdlFile ?>&amp;idx=<?php echo $VAR->idx ?>"
  method="put"
></form>
...
HTML
      ...
      <div
        ...
        <div id="wgt-tab-<?php echo $idPrefix ?>_desc-body" class="wgt_tab_body" >
          ...
          <div
            ...
            <fieldset
              ...
              (
                'Description',
                'backpath-description-'.$lang,
                $description,
                array
                (
                  'name' => 'backpath[description]['.$lang.']',
                  'style' => 'width:740px;'
                ),
                $formId,
                null,
        ...
        <div class="wgt-panel" >
          <select
            id="wgt-select-backpath-lang-<?php echo $VAR->idx ?>"
            name="label[lang]"
