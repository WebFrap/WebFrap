...
$idPrefix = $domainKey.'-'.$parentNode->getName().'-permission-create';
...
<form
  id="<?php echo $formId ?>"
  action="ajax.php?c=Daidalos.BdlNode_<?php echo $domainClass ?>Permission.insert&amp;key=<?php echo $VAR->key ?>&amp;bdl_file=<?php echo $VAR->bdlFile ?>"
  method="post"
></form>
