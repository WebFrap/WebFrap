...
$idPrefix = 'profile-'.$profile->getName().'-permission-edit-'.$VAR->idx;
...
<form
  id="<?php echo $formId ?>"
  action="ajax.php?c=Daidalos.BdlNode_ProfilePermission.update&amp;key=<?php echo $VAR->key ?>&amp;bdl_file=<?php echo $VAR->bdlFile ?>&amp;idx=<?php echo $VAR->idx ?>"
  method="put"
></form>
