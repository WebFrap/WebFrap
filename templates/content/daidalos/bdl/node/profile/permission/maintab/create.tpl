...
$idPrefix = 'profile-permission-create';
...
<var id="select_src-permission-level" >
[
{"i":"denied","v":"Denied"},
{"i":"listing","v":"Listing"},
{"i":"assign","v":"Assign"},
...
<form
  id="<?php echo $formId ?>"
  action="ajax.php?c=Daidalos.BdlNode_ProfilePermission.insert&amp;key=<?php echo $VAR->key ?>&amp;bdl_file=<?php echo $VAR->bdlFile ?>"
  method="post"
></form>
    ...
    <fieldset class="wgt-space bw61" >
      ...
      <div class="left bw6" >
        ...
        (
          ...
          $idPrefix.'-name',
          '',
          'ajax.php?c=Bdl.Management_Service.autocomplete&amp;key=',
          array
          (
...
<select
      ...
      data_source="select_src-permission-level"
...
HTML
      ...
      <div
        ...
        <div class="wgt-panel" >
          <select
            id="wgt-select-profile-description-new-lang"
            name="label[lang]"
            data_source="select_src-profile-lang"
