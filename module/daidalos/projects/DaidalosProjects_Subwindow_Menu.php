 ...
 * @copyright Webfrap Developer Network <contact@webfrap.net>
 */
class DaidalosProjects_Subwindow_Menu
  extends WgtDropmenu
{
////////////////////////////////////////////////////////////////////////////////
// Methoden
...
{$entries->report}
  ...
  <li class="wgt-root" >
    <button class=" wgtac_search wcm wcm_ui_button" >{$iconSearch} {$this->view->i18n->l('Search','wbf.label')}</button>
...
}//end class DaidalosProjects_Subwindow_Menu
