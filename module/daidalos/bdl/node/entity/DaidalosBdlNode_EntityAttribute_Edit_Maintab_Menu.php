 ...
 * @copyright Webfrap Developer Network <contact@webfrap.net>
 */
class DaidalosBdlNode_EntityAttribute_Edit_Maintab_Menu extends WgtDropmenu
{
/*//////////////////////////////////////////////////////////////////////////////
// Methoden
//////////////////////////////////////////////////////////////////////////////*/
...
HTML;
  ...
  public function injectActions( $idx, $view, $params )
  {
    ...
    $entityName = $view->model->entityNode->getName();
    ...
    self.getObject().find(".wgtac_save").click(function(){
      \$R.form(
        'wgt-form-bdl_entity-{$entityName}-attribute-edit-{$idx}',
        null,
        {"statusCallback":{
...
}//end class DaidalosBdlNode_ProfileBackpath_Edit_Maintab_Menu
