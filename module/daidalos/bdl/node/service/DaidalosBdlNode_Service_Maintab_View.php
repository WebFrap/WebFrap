 ...
 * @copyright Webfrap Developer Network <contact@webfrap.net>
 */
class DaidalosBdlNode_Service_Maintab_View extends WgtMaintabCustom
{

  /**
   * @var DaidalosBdlNode_Service_Model
   */
  public $model = null;
...
//////////////////////////////////////////////////////////////////////////////*/
  ...
  public function displayEditor(  $params )
  {
    ...
    $serviceName = $this->model->node->getName();

    $this->setLabel( 'Service: '.$serviceName );
    ...
    $this->setTabId( 'wgt-tab-daidalos-bdl_service-edit-'.$this->model->modeller->key );
...
}//end class DaidalosBdlNodeService_Maintab_View
