 ...
 * @copyright Webfrap Developer Network <contact@webfrap.net>
 */
class DaidalosBdlNode_Service_Controller extends Controller
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
//////////////////////////////////////////////////////////////////////////////*/
...
//////////////////////////////////////////////////////////////////////////////*/
  ...
  public function service_update($request, $response )
  {
    ...
    $nodeModel = $this->loadModel( 'DaidalosBdlNode_Service' );
    $nodeModel->loadBdlNode($model );

    $nodeModel->saveRequest($request);

    $response->addMessage( "Saved Service Data" );

  }//end public function service_update */

} // end class DaidalosBdlNode_Service_Controller
