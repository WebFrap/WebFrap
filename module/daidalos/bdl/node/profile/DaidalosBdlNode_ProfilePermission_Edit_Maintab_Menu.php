 ...
 * @copyright Webfrap Developer Network <contact@webfrap.net>
 */
class DaidalosBdlNode_ProfilePermission_Edit_Maintab_Menu extends WgtDropmenu
{
/*//////////////////////////////////////////////////////////////////////////////
// Methoden
//////////////////////////////////////////////////////////////////////////////*/
...
HTML;
  ...
  public function injectActions($idx, $view, $params)
  {
    ...
    self.getObject().find(".wgtac_save").click(function(){
      \$R.form(
        'wgt-form-bdl_profile-{$profileName}-permission-edit-{$idx}',
        null,
        {"statusCallback":{
...
}//end class DaidalosBdlNode_ProfilePermission_Edit_Maintab_Menu
