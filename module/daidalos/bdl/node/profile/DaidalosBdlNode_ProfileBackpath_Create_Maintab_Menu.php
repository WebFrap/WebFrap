 ...
 * @copyright Webfrap Developer Network <contact@webfrap.net>
 */
class DaidalosBdlNode_ProfileBackpath_Create_Maintab_Menu extends WgtDropmenu
{
/*//////////////////////////////////////////////////////////////////////////////
// Methoden
//////////////////////////////////////////////////////////////////////////////*/
...
HTML;
  ...
  public function injectActions($view, $params)
  {
    ...
    self.getObject().find(".wgtac_save").click(function(){
      \$R.form(
        'wgt-form-bdl_profile-backpath-create',
        null,
        {"statusCallback":{
...
}//end class DaidalosBdlNode_ProfileBackpath_Maintab_Menu
