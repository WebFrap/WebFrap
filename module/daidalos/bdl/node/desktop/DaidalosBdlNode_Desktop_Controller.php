 ...
 * @copyright Webfrap Developer Network <contact@webfrap.net>
 */
class DaidalosBdlNode_Desktop_Controller extends Controller
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
//////////////////////////////////////////////////////////////////////////////*/
...
//////////////////////////////////////////////////////////////////////////////*/
  ...
  public function service_update($request, $response)
  {
    ...
    $nodeModel = $this->loadModel('DaidalosBdlNode_Desktop');
    $nodeModel->loadBdlNode($model);

    $nodeModel->saveRequest($request);

    $response->addMessage("Saved Desktop Data");

  }//end public function service_update */

} // end class DaidalosBdlNode_Desktop_Controller
