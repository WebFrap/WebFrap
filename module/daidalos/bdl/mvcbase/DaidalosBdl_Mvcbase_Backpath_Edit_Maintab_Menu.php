 ...
 * @copyright Webfrap Developer Network <contact@webfrap.net>
 */
class DaidalosBdl_Mvcbase_Backpath_Edit_Maintab_Menu extends WgtDropmenu
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
//////////////////////////////////////////////////////////////////////////////*/
...
HTML;
  ...
  public function injectActions($idx, $view, $params)
  {
    ...
    self.getObject().find(".wgtac_save").click(function() {
      \$R.form(
        'wgt-form-bdl_{$this->domainKey}-{$pNodeName}-backpath-edit-{$idx}',
        null,
        {"statusCallback":{
...
}//end class DaidalosBdl_Mvcbase_Backpath_Edit_Maintab_Menu
