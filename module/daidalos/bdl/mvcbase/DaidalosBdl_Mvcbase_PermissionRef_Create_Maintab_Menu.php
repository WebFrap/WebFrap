 ...
 * @copyright Webfrap Developer Network <contact@webfrap.net>
 */
class DaidalosBdl_Mvcbase_PermissionRef_Create_Maintab_Menu extends WgtDropmenu
{
/*//////////////////////////////////////////////////////////////////////////////
// Attributes
//////////////////////////////////////////////////////////////////////////////*/
...
HTML;
  ...
  public function injectActions($view, $params)
  {
    ...
    self.getObject().find(".wgtac_save").click(function() {
      \$R.form(
        'wgt-form-bdl_{$this->domainKey}-permission-ref-create',
        null,
        {"statusCallback":{
...
}//end class DaidalosBdl_Mvcbase_PermissionRef_Create_Maintab_Menu
