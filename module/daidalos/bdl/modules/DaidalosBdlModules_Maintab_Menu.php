 ...
 * @copyright Webfrap Developer Network <contact@webfrap.net>
 */
class DaidalosBdlModules_Maintab_Menu extends WgtDropmenu
{
/*//////////////////////////////////////////////////////////////////////////////
// Methoden
//////////////////////////////////////////////////////////////////////////////*/
...
{$entries->support}
  ...
  <li class="wgt-root" >
    <button class="wgt-button wgtac_new_module" >{$iconNew} {$this->view->i18n->l('Create Module','wbf.label')}</button>
...
HTML;
  ...
  public function injectActions( $view, $params )
  {
    ...
    self.getObject().find(".wgtac_new_module").click(function(){
      \$R.get('maintab.php?c=Daidalos.BdlModules.createModule');
    });
