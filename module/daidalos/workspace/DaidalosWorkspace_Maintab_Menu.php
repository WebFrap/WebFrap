 ...
 * @copyright Webfrap Developer Network <contact@webfrap.net>
 */
class DaidalosWorkspace_Maintab_Menu extends WgtDropmenu
{
/*//////////////////////////////////////////////////////////////////////////////
// Methoden
//////////////////////////////////////////////////////////////////////////////*/
...
{$entries->support}
  ...
  <li class="wgt-root" >
    <button class="wgt-button wgtac_create_repo" >{$iconAdd} {$this->view->i18n->l('Create Repo','wbf.label')}</button>
    <ul style="margin-top:-10px;" ></ul>
  </li>
  <li class="wgt-root" >
    <button class="wgt-button wgtac_create_project" >{$iconAdd} {$this->view->i18n->l('Create Project','wbf.label')}</button>
    <ul style="margin-top:-10px;" ></ul>
  </li>
  <li class="wgt-root" >
    <button class="wgt-button wgtac_sync_index" >{$iconSync} {$this->view->i18n->l('Sync Index','wbf.label')}</button>
    <ul style="margin-top:-10px;" ></ul>
  </li>
</ul>
HTML;
