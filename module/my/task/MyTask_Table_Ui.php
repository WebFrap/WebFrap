...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function createListItem( $data, $params  )
  {
    ...
    $table = new MyTask_Table_Element('tableMyTask',$view);
...
JSCODE;
   ...
   * die MyTask listing maske
   *
   * @param MyTask_Table_Model $model
   * @param TFlag $params
   * @return void
   */
  public function searchForm(  $model, $params = null )
  {
    ...
    $entityMyTask  = $model->getEntityMyTask();
