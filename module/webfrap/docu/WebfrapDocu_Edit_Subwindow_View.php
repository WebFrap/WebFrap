 ...
 * @copyright Webfrap Developer Network <contact@webfrap.net>
 */
class WebfrapDocu_Edit_Subwindow_View
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  public function displayForm( $helpPage )
  {
    ...
    $this->setTemplate( 'webfrap/docu/subwindow/edit' );
...
<div class="wgt-panel-control" >
  <button class="wgtac_save wgt-button" >{$iconSave} {$i18n->l('Save','wbf.label')}</button>
</div>

<div class="wgt-panel-control" >
  <button class="wgtac_save_a_close wgt-button" >{$iconSave} {$i18n->l('Save & Show','wbf.label')}</button>
</div>
