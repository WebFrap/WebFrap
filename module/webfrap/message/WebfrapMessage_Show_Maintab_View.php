...
HTML;
  ...
  public function injectActions( $menu, $params )
  {
    ...
    self.getObject().find(".wgtac_forward").click( function(){
      \$R.get( 'maintab.php?c=Webfrap.Message.formFoward&msg_id={$message->msg_id}',{success:function(){ self.close(); }} );
    });
    
    self.getObject().find(".wgtac_reply").click( function(){
      \$R.get( 'maintab.php?c=Webfrap.Message.formReply&msg_id={$message->msg_id}',{success:function(){ self.close(); }} );
    });
