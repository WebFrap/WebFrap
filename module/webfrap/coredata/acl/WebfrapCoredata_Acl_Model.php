 ...
 */
class WebfrapCoredata_Acl_Model
...
////////////////////////////////////////////////////////////////////////////////
  ...
  */
  ...
  public function getAreaId()
  {
    ...
    $orm = $this->getOrm();
    return $orm->getByKey( 'WbfsysSecurityArea', 'mod-'.$this->domainKey.'-cat-core_data' )->getid();
  ...
  public function connect(  $params )
  {
    ...
    try
    {
      ...
      else
      {
        ...
        $partialMod->id_area     = $orm->getByKey( 'WbfsysSecurityArea', 'mod-'.$this->domainKey );
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function search( $areaId, $access, $params )
  {
    ...
    $db         = $this->getDb();
    $query      = $db->newQuery( 'WebfrapCoredata_Acl_Table' );
    /* @var $query WebfrapCoredata_Acl_Table_Query  */
...
} // end class WebfrapCoredata_Acl_Model */
