 ...
 */
class WebfrapCoredata_Acl_Table_Element
...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id       = 'wgt-table-project_iteration-acl';
  ...
  */
  public function loadUrl()
  {
    ...
    (
      ...
      (
        Wgt::ACTION_PAGING ,
        'index.php?c=Webfrap.Coredata_Acl.search'
      ),
      'delete'  => array
      (
        Wgt::ACTION_DELETE,
      ...
      (
        ...
        'Inherit Rights',
        'maintab.php?c=Webfrap.Coredata_Acl_Path.showGraph&amp;objid=',
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildThead( )
  {
    ...
    if( $this->enableNav )
      $html .= '<th style="width:100px;">'.$this->view->i18n->l( 'Nav.', 'wbf.label'  ).'</th>'.NL;
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildAjax( )
  {
    ...
    if( $this->appendMode )
    {
      ...
      if( $this->dataSize > ($this->start + $this->stepSize) )
      {
        $body .= '<tr><td class="pos" ></td><td colspan="'.$numCols.'" class="wcm wcm_action_appear '.$this->searchForm.' '.$this->id.'"  ><var>'.($this->start + $this->stepSize).'</var>Paging to the next '.$this->stepSize.' entries.</td></tr>';
      }
...
} // end class WebfrapCoredata_Acl_Table_Element */
