...
////////////////////////////////////////////////////////////////////////////////
  ...
  \$S('table#wgt-grid-mediathek-{$elementId}-document-table').grid('reColorize').grid('incEntries');
...
WGTJS;
  ...
  \$S('table#wgt-grid-mediathek-{$elementId}-document-table').grid('reColorize');
...
WGTJS;
  ...
  \$S('table#wgt-grid-mediathek-{$elementId}-document-table').grid('reColorize').grid('decEntries');
...
WGTJS;
  ...
  \$S('table#wgt-grid-mediathek-{$elementId}-document-table').grid('reColorize').grid('setNumEntries','{$numElem}');
