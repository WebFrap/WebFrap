 ...
 */
class BdlManagementReference_Service_Controller
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function service_autocomplete( $request, $response )
  {
    ...
    if( !$this->acl->access( 'mod-bdl>mgmt-bdl_management_reference:listing'  ) )
    {
    ...
    $params->contextKey = 'bdl_management_reference-service-autocomplete';

    $view  = $response->loadView
    (
      'BdlManagementReference_Service', 
			 'BdlManagementReference_Service',
      'displayAutocomplete',
      View::AJAX
     );
    
    $model  = $this->loadModel( 'BdlManagementReference_Service' );
...
}//end class BdlManagementReference_Service_Controller
