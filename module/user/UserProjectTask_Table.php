...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @var string $id
   */
  public $id       = 'wgt-table-user_project_task';
  ...
  (
    ...
    (
      Wgt::ACTION_JS,
      'edit',
      'maintab.php?c=Project.Task.edit&amp;objid=',
      'control/edit.png',
      'wcm wcm_req_ajax',
    ...
    (
      Wgt::ACTION_DELETE,
      'delete',
      'maintab.php?c=Project.Task.delete&amp;objid=',
      'control/delete.png',
      'wcm wcm_req_del',
...
////////////////////////////////////////////////////////////////////////////////
  ...
  public function buildTbody( )
  {
    ...
    foreach( $this->data as $key => $row   )
    {
      ...
      $body .= '<td valign="top" >
        type: '.Validator::sanitizeHtml($row['project_task_type_name']).'<br />
        status: '.Validator::sanitizeHtml($row['project_task_status_name']).'
        </td>'.NL;
      $body .= '<td valign="top" >
        start: '.Validator::sanitizeHtml($row['project_task_employee_date_start']).'<br />
        end: '.Validator::sanitizeHtml($row['project_task_employee_date_end']).'
        </td>'.NL;
