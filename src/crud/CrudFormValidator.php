...
class CrudFormValidator extends BaseChild
{
     ...
     */
    public function validateUpdate($entity, $keyName, $fields = array(), $required = array(), $publishErrors = true)
    {
     ...
     * @return array
     */
    public function checkMultiFormInput($values, $messages, $subkey = null, $required = array(), $state = null)
    {
     ...
     *
     */
    public function validateMultiData($values, $subkey = null, $messages = array(), $state = null)
    {
        $post = array();
     ...
     * @return array
     */
    public function validate($entity, $keyName, $fields = array(), $required = array(), $state = null)
    {
     ...
     */
    public function validateMultiInsert($entityName, $keyName, $fields = array(), $required = array(), $state = null)
    {
        $orm = $this->getOrm();
     ...
     * @return [Entity]
     */
    public function validateMultiUpdate($entityKey, $keyName, $fields = array(), $required = array())
    {
     ...
     * @param array $required            
     */
    public function validateMultiSave($entityName, $keyName, $fields = array(), $required = array(), $defaults = array())
    {
        $orm = $this->getOrm();
