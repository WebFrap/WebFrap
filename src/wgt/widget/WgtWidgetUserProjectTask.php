  ...
  extends WgtWidget
{
  ...
  public function asTab( $containerId, $tabId, $tabSize = 'medium' )
  {
    ...
    $query = $db->newQuery('UserProjectTask_Table');
    ...
    $table = new UserProjectTask_Table();
    $table->view = $view;
    ...
    */
    ...
    <div id="{$tabId}" class="wgt_tab {$tabSize} {$containerId}" title="my tasks"  >
      <form
        id="wgt-form-user_project_task-search"
        method="post"
        action="index.php?c=Widget.UserProjectTask.reload"  ></form>
...
} // end class WgtWidgetUserProjectTask
