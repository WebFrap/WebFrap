  ...
  extends LibSpreadsheetExcelStyle
{
  ...
  public $table_row_color1        =  'FFDBE5F1';
  public $table_row_color2        =  'FFB8CCE4';
  ...
  public $project_basic_data_color1  =  'FFDBE5F1';
  public $project_basic_data_color2  =  'FF8DB4E3';
  ...
  public function styleArray( $color, $font, $bold = false, $border  )
  {
  ...
  public function getTableRowsStyle( $switch )
  {
    if( $switch )
    {
      $color = $this->table_row_color1;
    }
    else
    {
      $color = $this->table_row_color2;
    }
