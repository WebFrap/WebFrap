...
////////////////////////////////////////////////////////////////////////////////
   ...
   * @param int $errorKey
   */
  public function __construct( $message, $debugMessage = 'Invalid Request', $errorKey = Response::BAD_REQUEST  )
  {
    ...
    {
      if( DEBUG && 'Invalid Request' != $debugMessage && !is_numeric($debugMessage) )
        parent::__construct( $debugMessage );
      else
