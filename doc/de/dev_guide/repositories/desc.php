<h1>Übersicht über die WebFrap Repositories</h1>

<p>Es gibt innerhalb von WebFrap 5 Repository Container</p>

<label>Container</label>
<ul>
  <li>Core https://hg.webfrap-servers.de/core</li>
  <li>GenF https://hg.webfrap-servers.de/genf</li>
  <li>Buiz https://hg.webfrap-servers.de/buiz</li>
  <li>Demo https://hg.webfrap-servers.de/demo</li>
  <li>Vendor https://hg.webfrap-servers.de/vendor</li>
</ul>

<p>Alle Repositories enthalten mindestens 3 Branches</p>
...
<ul class="doc-tree" >
  <li><h2><a href="content.php?page=dev_guide.repositories.core.desc" target="main" >Core</h2></a>
    <p>
      ...
      auf der WBF Platform basierten Applikation nötigen Projekte.
    </p>
    <ul>
  ...
  <li><h2><a href="content.php?page=dev_guide.repositories.core.desc" target="main" >GenF</h2></a>
    <p>
      Der GenF Node enthält alle Generator / Compiler spezifischen Projekte.
    </p>
    <ul>
  ...
  <li><h2><a href="content.php?page=dev_guide.repositories.buiz.desc" target="main" >Buiz</h2></a>
    <p>
      Buiz enthält alle Softwarepackete die für den Betrieb einer Enterprise ready RIA Platform nötig sind.<br />
    </p>
    <ul>
  ...
  <li><h2><a href="content.php?page=dev_guide.repositories.demo.desc" target="main" >Demo</h2></a>
    <p>
      Demo Projekte
    </p>
    <ul>
  ...
  <li><h2><a href="content.php?page=dev_guide.repositories.vendor.desc" target="main" >Vendor</h2></a>
    <p>
      Mapper Projekte für Thirdparty Libraries
    </p>
    <ul>
      ...
      <li><a href="content.php?page=dev_guide.repositories.vendor.webfrap_lib_system_process" target="main" >WebFrap_Lib_SystemProcess</a></li>
    </ul>
  </li>
</ul>