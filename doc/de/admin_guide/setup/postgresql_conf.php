...
<h2>Setup User and Database</h2>

<p>
Um das System zu initialisieren muss zuerst die PostgreSQL Datenbank vorbereitet
werden. Wir brauchen einen Admin User für die Administration, einen User für die
Applikation und natürlich eine Datenbank.<br />
Es gibt zwei Möglichkeiten die Datenbank vorzubereiten, entweder über die 
Konsole oder per SQL.
</p>

<label>Version 1: Console</label>

<?php start_highlight(); ?>
you@yourdesk:~$ sudo su postgres
[sudo] password for you: 
postgres@yourdesk:/home/you$

postgres@yourdesk:/home/you$ createuser admin_user -P
...
postgres@yourdesk:/home/you$ createuser system_user -P
Geben Sie das Passwort der neuen Rolle ein: 
Geben Sie es noch einmal ein: 
...
<p>
Bisher existiert nur der Standarduser also müssen wir uns als Standarduser 
...
<?php start_highlight(); ?>
-- admin user anlegen
CREATE USER admin_user with password '53cr37P455w0r6' createuser createdb;

- system user anlegen
CREATE USER app_user with password '53cr37P455w0r6';
...
<p>Bitte nicht einfach kopieren, sondern die eigene Conf anpassen!</p>
<?php start_highlight(); ?>
